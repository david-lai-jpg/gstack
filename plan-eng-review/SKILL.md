...
4. **Search check:** For each architectural pattern, infrastructure component, or concurrency approach the plan introduces:
   ...
   If the plan rolls a custom solution where a built-in exists, flag it as a scope reduction opportunity. Annotate recommendations with **[Layer 1]**, **[Layer 2]**, or **[Layer 3]** (see preamble's Search Before Building section). If you find a first-principles reason the standard approach is wrong for this case, present it as an architectural insight.
