...
describe('gen-skill-docs', () => {
  ...
  test('generated SKILL.md does not contain usage reporting lines', () => {
    const content = fs.readFileSync(path.join(ROOT, 'SKILL.md'), 'utf-8');
  ...
  test('preamble no longer has pending marker glob handling', () => {
    for (const skill of CLAUDE_GENERATED_SKILLS) {
      const content = fs.readFileSync(path.join(ROOT, skill.dir, 'SKILL.md'), 'utf-8');
...
describe('SPEC_REVIEW_LOOP resolver', () => {
  ...
  test('does not write review metrics files', () => {
...
describe('usage reporting removal', () => {
  test('generated SKILL.md omits usage-reporting start, prompt, epilogue, and pending handling', () => {
    const content = fs.readFileSync(path.join(ROOT, 'SKILL.md'), 'utf-8');
  ...
  test('preamble skills omit usage-reporting blocks', () => {
...
describe('community fixes wave', () => {
  ...
  test('preamble does not write usage JSONL files', () => {
...
describe('plan-mode-info resolver (handshake-replacement)', () => {
  ...
  test('plan-mode-info remains early and update checks are absent from preamble', () => {
