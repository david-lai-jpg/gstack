...
description: |
  ...
  and code quality metrics with persistent local history and trend tracking.
...
```json
{
  ...
  "authors": {
    "Jordan": { "commits": 32, "insertions": 2400, "deletions": 300, "test_ratio": 0.41, "top_area": "browse/" },
